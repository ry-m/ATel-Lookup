# ATel Lookup
The ATel Lookup appplication is a web-based application that imports ATel reports from [The Astronomer's Telegram](https://astronomerstelegram.org/). This tool extracts useful information from the report body text to enable categorical organisation. This allows for searching via a variety of filtering options such as dates, names, aliases, types and more. A visualisation function also links related reports together using a timeline and network graph. 
